...
<body style="background-color: #C6EFFF;">
	<div style="position: fixed; top: 50%; left: 50%; margin-top: -320px; margin-left: -512px;">
		<img id="introimg" src="{{ asset('/intro_1.png') }}" style="visibility: hidden;">
		<a href="/intro" style="position: absolute; bottom: 0; right: 20px;">
			<img id="introbtn" src="{{ asset('/next.png') }}" width="150" style="visibility: hidden;">
		</a>
	</div>
